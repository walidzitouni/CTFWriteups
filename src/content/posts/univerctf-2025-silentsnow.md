...
![Challenge Homepage](../../assets/images/silentsnow/1.png)
...
![WordPress Structure](../../assets/images/silentsnow/2.png)

## Vulnerability Discovery

**Location:** `/src/plugins/my-plugin/my-plugin.php:110`

![Vulnerable Code](../../assets/images/silentsnow/3.png)
...
![Auto-login Feature](../../assets/images/silentsnow/4.png)

### 2. Admin Context Bypass

Endpoint for the settings!

![Admin Bypass](../../assets/images/silentsnow/5.png)
...
![Settings Page](../../assets/images/silentsnow/6.png)

This returns the settings form with a valid nonce: `5602f77aca`

![Nonce](../../assets/images/silentsnow/7.png)
...
![Enable Registration](../../assets/images/silentsnow/8.png)
...
![Set Admin Role](../../assets/images/silentsnow/9.png)
